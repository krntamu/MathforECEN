...
%\begin{axis}[]
	\begin{axis}[enlarge x limits=0,
		...
		ylabel={$|H(jw)|$},
			width = 0.7\textwidth,
		height = 0.3\textwidth, ]
	\addplot[trig format =rad,black,domain=-10:10,samples=200,thick]{1/sqrt(1+x^2)}; % plot of real part of figure1.4
...
\end{axis}
	...
	\begin{axis}[enlarge x limits=0,
		...
		height = 0.3\textwidth,]
	\addplot[trig format =rad,black,domain=-10:10,samples=200,thick]{-atan(x)}; % plot of imaginary part of figure 1.4
